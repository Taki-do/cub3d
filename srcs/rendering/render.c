...
void	load_all_textures(t_data *data)
{
	...
	load_texture(data->mlx, "textures/Cacodemons.xpm",
		&data->monster_texture[0], data);
	load_texture(data->mlx, "textures/Cacodemons_shoot.xpm",
		&data->monster_texture[1], data);
	load_texture(data->mlx, "textures/Cacodemons_dead.xpm",
		&data->monster_texture[2], data);
	load_texture(data->mlx, "textures/shotgun_frame1.xpm",
		&data->shotgun[0], data);
	load_texture(data->mlx, "textures/shotgun_frame2.xpm",
		&data->shotgun[1], data);
	load_texture(data->mlx, "textures/shotgun_frame3.xpm",
		&data->shotgun[2], data);
